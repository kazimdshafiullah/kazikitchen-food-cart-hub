...
const FrozenFoodCheckout = () => {
  ...
  // Calculate delivery fee for frozen food - 70 BDT, free above 500 BDT
  ...
  if (cart.length === 0 && !orderPlaced) {
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        ...
        <p className="mb-4">Add some frozen food items to your cart!</p>
        <Button asChild>
          <Link to="/frozen-food">Browse Frozen Food</Link>
        </Button>
      </div>
    );
  }
    ...
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        <div className="max-w-md mx-auto bg-green-50 p-8 rounded-lg">
          ...
          <p className="text-gray-600 mb-6">Thank you for your frozen food order!</p>
          <div className="space-y-3">
            <Button asChild className="w-full">
              <Link to="/frozen-food">Continue Shopping</Link>
            </Button>
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-bold">Frozen Food Checkout</h2>
...
export default FrozenFoodCheckout;
